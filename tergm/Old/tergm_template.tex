...
$if(title)$
\title{STERGM - Separable Temporal ERGMs for modeling discrete relational dynamics with statnet}
$endif$
\author{
...
Pavel N. Krivtisky, University of Wollongong\\
