...
head(fmh.egosampN4w)
```
For example, for every Black student, there are about `r round(race_counts["White"]/race_counts["Black"])` students, and under the sampling design, there are about `r round(sum(fmh.egosampN4w$ego$variables$Race=="White")/sum(fmh.egosampN4w$ego$variables$Race=="Black"))`.
