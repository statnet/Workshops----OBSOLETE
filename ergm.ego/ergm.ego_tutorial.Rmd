...
<!-- WE NEED A QUICK OVERVIEW OF SURVEY DESIGN AND WEIGHTS IN EGOR -->

<!-- Some special methods are also implemented for working with `egor` objects -->

<!-- * `sample` -- takes a sample of the egos, bringing along their alters and alter-alter ties into a new `egor` object. -->
...
Suppose that we oversample the minority groups by a factor of 4. We
...
se.compare <- data.frame(
  "NW SE" = model.se(fit.ergm),
  "Ego Samp4 SE" = model.se(egofitN4)[-1],
  "Ego 0Samp SE" = model.se(egofitN4w)[-1])
